...
class GameLoop:
    ...
    def main(self):
        ...
        self.cellsize = self.get_cell_size(800, 600, self.ctrl.cellsx, self.ctrl.cellsy)
        ...
        while True:
            ...
            if(self.ctrl.cellschanged):
                ...
                self.cellsize = self.get_cell_size(self.surface.get_size()[0],self.surface.get_size()[1], self.ctrl.cellsx, self.ctrl.cellsy)
